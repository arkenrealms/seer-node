        ...
        if (e.name === 'Transfer') {
          ...
          if (from === '0x0000000000000000000000000000000000000000') {
            ...
            if (decodedItem.rarity.id === ItemRarity.Mythic.id) {
              ...
              await app.notices.add('item-craft', {
                key: 'item-craft',
                address: token.owner,
                itemName: decodedItem.name,
                tokenId: itemData.tokenId,
              ...
              await app.api.emitAll('PlayerAction', {
                ...
                tokenId: itemData.tokenId,
                username: user.username,
                message: `${user.username || `${userAddress.slice(0, 7)}...`} crafted a magical ${decodedItem.name}`,
              })
            }
          } else {
            ...
            if (
              ![
                '0xcfA857d6EC2F59b050D7296FbcA8a91D061451f3',
                '0x5fE24631136D570D12920C9Fa0FEcaDA84E47673',
                '0x85C07b6a475Ee19218D0ef9C278C7e58715Af842',
              ...
              await app.api.emitAll('PlayerAction', {
                ...
                message: `${fromUser.username || `${from.slice(0, 7)}...`} transfered ${decodedItem.name} to ${
    ...
    if (parseInt(blockNumber) > 10000) {
      ...
      for (const event of events) {
        await iterateBlocks(
          ...
          `Items Events: ${event}`,
          getAddress(app.contractInfo.items),
          app.config.items.lastBlock[event],
          blockNumber,
          contract.filters[event](),
          processLog,
