  ...
  const evolutionServers = [
    {
      ...
      name: 'Oceanic',
      regionId: 1,
      endpoint: 'oceanic1.secondwind.zeno.games',
      status: 'offline',
      playerCount: 0,
      rewardItemAmount: 0,
    ...
    },
    {
      ...
      name: 'Europe',
      regionId: 1,
      endpoint: 'europe1.secondwind.zeno.games',
      status: 'offline',
      version: '1.6.3',
      rewardItemAmount: 0,
      rewardWinnerAmount: 0,
    ...
    },
    {
      ...
      name: 'Europe',
      regionId: 2,
      endpoint: 'europe2.secondwind.zeno.games',
      status: 'offline',
      version: '1.6.3',
      rewardItemAmount: 0,
      rewardWinnerAmount: 0,
    ...
    },
    {
      ...
      name: 'Europe',
      regionId: 3,
      endpoint: 'europe3.secondwind.zeno.games',
      status: 'online',
      version: '1.6.3',
    ...
    },
    {
      ...
      name: 'North America',
      regionId: 1,
      endpoint: 'na1.secondwind.zeno.games',
      status: 'offline',
      playerCount: 0,
      rewardItemAmount: 0,
      rewardWinnerAmount: 0,
    ...
    },
    {
      ...
      name: 'South America',
      regionId: 1,
      endpoint: 'sa1.secondwind.zeno.games',
      status: 'offline',
      playerCount: 0,
      rewardItemAmount: 0,
      rewardWinnerAmount: 0,
    ...
    },
    {
      ...
      name: 'South America',
      regionId: 2,
      endpoint: 'sa2.secondwind.zeno.games',
      status: 'offline',
      playerCount: 0,
      rewardItemAmount: 0,
      rewardWinnerAmount: 0,
    ...
    },
    {
      ...
      name: 'South America',
      regionId: 3,
      endpoint: 'sa3.secondwind.zeno.games',
      status: 'offline',
      playerCount: 0,
      rewardItemAmount: 0,
      rewardWinnerAmount: 0,
    ...
    },
    {
      ...
      name: 'South America',
      regionId: 4,
      endpoint: 'sa4.secondwind.zeno.games',
      status: 'offline',
      playerCount: 0,
      rewardItemAmount: 0,
      rewardWinnerAmount: 0,
    ...
    },
    {
      ...
      name: 'South America',
      regionId: 5,
      endpoint: 'sa5.secondwind.zeno.games',
      status: 'offline',
      playerCount: 0,
      rewardItemAmount: 0,
      rewardWinnerAmount: 0,
    ...
    },
    {
      ...
      name: 'Asia',
      regionId: 1,
      endpoint: 'asia1.secondwind.zeno.games',
      status: 'offline',
      playerCount: 0,
      rewardItemAmount: 0,
      rewardWinnerAmount: 0,
    ...
    },
    {
      ...
      name: 'Asia',
      regionId: 2,
      endpoint: 'asia2.secondwind.zeno.games',
      status: 'offline',
      playerCount: 0,
      rewardItemAmount: 0,
      rewardWinnerAmount: 0,
    ...
    },
    {
      ...
      name: 'Asia',
      regionId: 3,
      endpoint: 'asia3.secondwind.zeno.games',
      status: 'offline',
      playerCount: 0,
      rewardItemAmount: 0,
      rewardWinnerAmount: 0,
    ...
    },
    {
      ...
      name: 'Asia',
      regionId: 4,
      endpoint: 'asia4.secondwind.zeno.games',
      status: 'offline',
      playerCount: 0,
      rewardItemAmount: 0,
      rewardWinnerAmount: 0,
    ...
    try {
      ...
      for (const address of Object.keys(playerRewards)) {
        ...
        for (const runeKey of Object.keys(user.lifetimeRewards.runes)) {
          ...
          user.rewards.runes[runeKey] =
            runeAmount - user.rewardHistory.filter((r) => r.rune === runeKey).reduce((sum, r) => sum + r.value, 0)
