...
export const ItemAttributes = {
  ...
  FractureItem: {
    ...
    min: 0,
    max: 100,
    description: `{value}% Chance To Fracture Item`,
  },
  LaunchPoolReward: {
    id: 15,
    min: 0,
    max: 50,
    description: `{value}% Launchpool Reward`,
  },
  LaunchPoolToken: {
    id: 16,
    min: 0,
  ...
  FreezeFees: {
    ...
    min: 0,
    max: 100,
    description: `{value}% Chance to Freeze Fees`,
  },
  UnableUseRuneword: {
    id: 18,
    min: 0,
    max: 999,
    description: `Unable To Use Runeword`,
  },
