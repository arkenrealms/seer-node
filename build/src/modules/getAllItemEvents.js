    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    _a.trys.push([1, 7, , 8]);
                    contract = new ethers_1.default.Contract((0, web3_1.getAddress)(app.contracts.items), app.contractMetadata.ArcaneItems.abi, app.signers.read);
                    iface_1 = new ethers_1.default.utils.Interface(app.contractMetadata.ArcaneItems.abi);
                ...
                case 2:
                    ...
                    _loop_1 = function (event_1) {
                        return __generator(this, function (_b) {
                            switch (_b.label) {
                                case 0: return [4 /*yield*/, (0, web3_1.iterateBlocks)(app.web3Provider.getLogs, "Items Events: ".concat(event_1), (0, web3_1.getAddress)(app.contracts.items), app.config.items.lastBlock[event_1], blockNumber, contract.filters[event_1](), processLog, function (blockNumber2) {
                                        return __awaiter(this, void 0, void 0, function () {
                                            return __generator(this, function (_a) {
