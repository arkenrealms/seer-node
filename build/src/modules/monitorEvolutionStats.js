...
function monitorEvolutionStats(app) {
    ...
    return __awaiter(this, void 0, void 0, function () {
        var _i, _f, server, rand, response, data, e_1, e_2, playerRoundWinners, playerRewardWinners, leaderboards, evolutionPlayers, mapAddressToUsername, _loop_1, _g, _h, server, _j, evolutionPlayers_1, player, user, latency, key, server, _k, _l, statKey, _m, _o, statKey, _p, _q, statKey, _loop_2, _r, evolutionPlayers_2, player, e_3, _s, _t, server, data, _u, _v, round, _w, round_1, player, _x, _y, server, stats, playerLatencyList, winnerLatencyList, _z, _0, round, winner, _1, round_2, player, _2, round_3, player, _loop_3, _3, _4, server, e_4, _5, _6, server, rand, response, data, e_5, e_6, _7, _8, server, rand, response, data, _9, data_1, banItem, user, e_7, e_8, _10, _11, server, rand, response, data, e_9, e_10, _12, _13, server, rand, response, data, e_11, e_12, _loop_4, _14, _15, server;
        return __generator(this, function (_16) {
            switch (_16.label) {
                case 0:
                    ...
                    _16.label = 1;
                case 1:
                    if (!(_i < _f.length)) return [3 /*break*/, 7];
                    server = _f[_i];
                ...
                case 2:
                    ...
                    return [4 /*yield*/, (0, node_fetch_1.default)("http://".concat(server.endpoint, "/data/playerRewards.json?").concat(rand))];
                case 3:
                    response = _16.sent();
                ...
                case 10:
                    ...
                    _g = 0, _h = app.db.evolutionServers;
                    _16.label = 11;
                case 11:
                ...
                case 14:
                    ...
                    _j = 0, evolutionPlayers_1 = evolutionPlayers;
                    _16.label = 15;
                case 15:
                    if (!(_j < evolutionPlayers_1.length)) return [3 /*break*/, 18];
                    player = evolutionPlayers_1[_j];
                    ...
                    for (_k = 0, _l = ['kills', 'deaths', 'powerups', 'evolves', 'points', 'rewards', 'orbs', 'revenges', 'rounds', 'wins', 'timeSpent', 'winRatio', 'killDeathRatio', 'roundPointRatio', 'averageLatency']; _k < _l.length; _k++) {
                        statKey = _l[_k];
                ...
                case 18:
                    // Sort descending
                    for (_m = 0, _o = ['kills', 'deaths', 'powerups', 'evolves', 'points', 'rewards', 'orbs', 'revenges', 'rounds', 'wins', 'timeSpent', 'winRatio', 'killDeathRatio', 'roundPointRatio']; _m < _o.length; _m++) {
                        statKey = _o[_m];
                    ...
                    // Sort ascending
                    for (_p = 0, _q = ['averageLatency']; _p < _q.length; _p++) {
                        statKey = _q[_p];
                    ...
                    _r = 0, evolutionPlayers_2 = evolutionPlayers;
                    _16.label = 19;
                case 19:
                    if (!(_r < evolutionPlayers_2.length)) return [3 /*break*/, 22];
                    player = evolutionPlayers_2[_r];
                ...
                case 24:
                    ...
                    try {
                        ...
                        for (_s = 0, _t = app.db.evolutionServers; _s < _t.length; _s++) {
                            server = _t[_s];
                            if (server.status !== 'online')
                                continue;
                            ...
                            try {
                                ...
                                for (_u = 0, _v = playerRoundWinners[server.key]; _u < _v.length; _u++) {
                                    ...
                                    if (server.status !== 'online')
                                        continue;
                                    for (_w = 0, round_1 = round; _w < round_1.length; _w++) {
                                        player = round_1[_w];
                    ...
                    try {
                        ...
                        for (_x = 0, _y = app.db.evolutionServers; _x < _y.length; _x++) {
                            server = _y[_x];
                            if (server.status !== 'online')
                                continue;
                            if (!playerRoundWinners[server.key])
                            ...
                            try {
                                ...
                                playerLatencyList = [];
                                winnerLatencyList = [];
                                for (_z = 0, _0 = playerRoundWinners[server.key]; _z < _0.length; _z++) {
                                    round = _0[_z];
                                    if (server.status !== 'online')
                                        continue;
                                    winner = void 0;
                                    for (_1 = 0, round_2 = round; _1 < round_2.length; _1++) {
                                        player = round_2[_1];
                                    ...
                                    for (_2 = 0, round_3 = round; _2 < round_3.length; _2++) {
                                        player = round_3[_2];
                                ...
                                stats.medianPlayerLatency = (0, math_1.median)(playerLatencyList);
                                stats.medianWinnerLatency = (0, math_1.median)(winnerLatencyList);
                ...
                case 39:
                    ...
                    return [3 /*break*/, 40];
                case 40:
                    _16.trys.push([40, 52, , 53]);
                    (0, util_2.log)('Update evolution ban list');
                    _7 = 0, _8 = app.db.evolutionServers;
                    _16.label = 41;
                case 41:
                    if (!(_7 < _8.length)) return [3 /*break*/, 51];
                    server = _8[_7];
                    if (server.status !== 'online')
                        return [3 /*break*/, 50];
                    (0, util_2.log)('Server', server.key);
                ...
                case 44:
                    ...
                    _16.label = 45;
                case 45:
                    if (!(_9 < data_1.length)) return [3 /*break*/, 48];
                    banItem = data_1[_9];
