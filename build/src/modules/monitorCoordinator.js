        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    return [4 /*yield*/, fetch("https://coordinator.rune.game/data/refers.json?".concat(rand))];
                case 1:
                    response = _a.sent();
                ...
                case 3:
                    ...
                    return [3 /*break*/, 4];
                case 4:
                    setTimeout(function () { return monitorCoordinator(app); }, 2 * 60 * 1000);
                    return [2 /*return*/];
            }
        });
    });
}
exports.monitorCoordinator = monitorCoordinator;
