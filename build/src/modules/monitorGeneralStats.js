        ...
        return __generator(this, function (_16) {
            switch (_16.label) {
                ...
                case 1:
                    _16.trys.push([1, 7, , 8]);
                    _e = app.db.stats;
                    return [4 /*yield*/, app.contracts.characters.totalSupply()];
                case 2:
                ...
                case 3:
                    ...
                    return [4 /*yield*/, app.contracts.characters.characterCount(i)];
                case 4:
                ...
                case 8:
                    ...
                    _g = app.db.stats;
                    return [4 /*yield*/, app.contracts.items.totalSupply()];
                case 9:
                ...
                case 10:
                    ...
                    return [4 /*yield*/, app.contracts.items.itemCount(i)];
                case 11:
                    _h.total = (_16.sent()).toNumber();
                    _j = app.db.stats.items[i];
                    return [4 /*yield*/, app.contracts.items.itemBurnCount(i)];
                case 12:
                ...
                case 22:
                    ...
                    tokenContract = new ethers.Contract((0, web3_1.getAddress)(farm.tokenAddresses), app.contractMetadata.BEP20.abi, app.signers.read);
                    lpContract = new ethers.Contract(farm.isTokenOnly ? (0, web3_1.getAddress)(farm.tokenAddresses) : lpAddress, app.contractMetadata.BEP20.abi, app.signers.read);
                    quotedContract = new ethers.Contract((0, web3_1.getAddress)(farm.quoteTokenAdresses), app.contractMetadata.BEP20.abi, app.signers.read);
                ...
                case 33:
                    ...
                    _s = app.config;
                    _t = util_1.toShort;
                    return [4 /*yield*/, app.contracts.characterFactory.tokenPrice()];
                case 34:
                    _s.characterMintCost = _t.apply(void 0, [(_16.sent()).toString()]);
                    _u = app.config;
                    _v = util_1.toShort;
                    return [4 /*yield*/, app.contracts.profile.numberRuneToRegister()];
                case 35:
                ...
                case 37:
                    ...
                    tokenContract = new ethers.Contract((0, web3_1.getAddress)(app.contractInfo[symbol]), app.contractMetadata.BEP20.abi, app.signers.read);
                    _y = util_1.toShort;
