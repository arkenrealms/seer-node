...
function getAllMarketEvents(app) {
    return __awaiter(this, void 0, void 0, function () {
        // @ts-ignore
        function processLog(logInfo, updateConfig) {
            ...
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_g) {
                    switch (_g.label) {
                        case 0:
                            e = iface_1.parseLog(logInfo);
                            (0, util_1.log)(e.name, e.args.tokenId);
                            ...
                            if (!(!trade || trade.blockNumber < logInfo.blockNumber)) return [3 /*break*/, 5];
                            trade = {
                            ...
                            (0, util_1.log)('Adding trade', trade);
                        ...
                        case 4:
                            _g.sent();
                            // await saveConfig()
                            (0, util_1.log)('List', trade);
                            _g.label = 5;
                        case 5:
                            if (!(e.name === 'Update')) return [3 /*break*/, 12];
                            _b = e.args, seller_2 = _b.seller, buyer = _b.buyer, tokenId_2 = _b.tokenId, price = _b.price;
                            specificTrades = app.db.trades.find(function (t) { return t.seller.toLowerCase() === seller_2.toLowerCase() && t.tokenId === tokenId_2.toString() && t.status === 'available' && t.blockNumber < logInfo.blockNumber; });
                        ...
                        case 10:
                            _g.sent();
                            (0, util_1.log)('Update', specificTrade);
                            _g.label = 11;
                        case 11:
                            _i++;
                            return [3 /*break*/, 6];
                        case 12:
                            ...
                            specificTrades = app.db.trades.filter(function (t) { return t.seller.toLowerCase() === seller_3.toLowerCase() && t.tokenId === tokenId_3.toString() && t.status === 'available' && t.blockNumber < logInfo.blockNumber; });
                        ...
                        case 13:
                            ...
                            // specificTrade.item = decodeItem(specificTrade.tokenId)
                            (0, util_1.log)('Delisting trade', specificTrade);
                        ...
                        case 17:
                            _g.sent();
                            (0, util_1.log)('Delist', specificTrade);
                            _g.label = 18;
                        case 18:
                            _d++;
                            return [3 /*break*/, 13];
                        case 19:
                            ...
                            specificTrades = app.db.trades.filter(function (t) { return t.seller.toLowerCase() === seller_4.toLowerCase() && t.tokenId === tokenId_4.toString() && t.status === 'available' && t.blockNumber < logInfo.blockNumber; });
                        ...
                        case 25:
                            _g.sent();
                            (0, util_1.log)('Buy', specificTrade);
                            _g.label = 26;
                        case 26:
                            _f++;
                            return [3 /*break*/, 20];
                        case 27:
                            e2 = app.db.tradesEvents.find(function (t) { return t.transactionHash === logInfo.transactionHash; });
                            if (!e2) {
                                app.db.tradesEvents.push(__assign(__assign({}, logInfo), e));
                            }
                            return [2 /*return*/];
                    }
                });
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    _a.trys.push([1, 7, , 8]);
                    iface_1 = new ethers.utils.Interface(app.contractMetadata.ArcaneTraderV1.abi);
                ...
                case 2:
                    ...
                    _loop_1 = function (event_1) {
                        return __generator(this, function (_b) {
                            switch (_b.label) {
                                case 0: return [4 /*yield*/, (0, web3_1.iterateBlocks)(app, "Market Events: ".concat(event_1), (0, web3_1.getAddress)(app.contractInfo.trader), app.config.trades.lastBlock[event_1], blockNumber, app.contracts.trader.filters[event_1](), processLog, function (blockNumber2) {
                                        return __awaiter(this, void 0, void 0, function () {
                                            return __generator(this, function (_a) {
