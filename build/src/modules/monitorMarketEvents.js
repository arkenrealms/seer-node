...
exports.monitorMarketEvents = void 0;
...
function monitorMarketEvents(app) {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            ...
            try {
                app.contracts.arcaneTrader.on('List', function () { return __awaiter(_this, void 0, void 0, function () {
                    var e_1;
                    return __generator(this, function (_a) {
                        switch (_a.label) {
                            case 0:
                                _a.trys.push([0, 2, , 3]);
                                return [4 /*yield*/, app.modules.getAllMarketEvents(app)];
                            case 1:
                                _a.sent();
                                return [3 /*break*/, 3];
                            case 2:
                ...
                app.contracts.arcaneTrader.on('Update', function () { return __awaiter(_this, void 0, void 0, function () {
                    var e_2;
                    return __generator(this, function (_a) {
                        switch (_a.label) {
                            case 0:
                ...
                app.contracts.arcaneTrader.on('Delist', function () { return __awaiter(_this, void 0, void 0, function () {
                    var e_3;
                    return __generator(this, function (_a) {
                        switch (_a.label) {
                            case 0:
                ...
                app.contracts.arcaneTrader.on('Buy', function () { return __awaiter(_this, void 0, void 0, function () {
                    var e_4;
                    return __generator(this, function (_a) {
                        switch (_a.label) {
                            case 0:
