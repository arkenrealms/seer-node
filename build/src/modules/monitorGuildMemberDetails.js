        ...
        return __generator(this, function (_h) {
            switch (_h.label) {
                ...
                case 4:
                    ...
                    _h.label = 5;
                case 5: return [4 /*yield*/, app.contracts.profile.hasRegistered(user.address)];
                case 6:
                    hasRegistered = (_h.sent());
                    if (!hasRegistered)
                        return [3 /*break*/, 10];
                    return [4 /*yield*/, app.contracts.profile.getUserProfile(user.address)];
                case 7:
                    ...
                    return [4 /*yield*/, app.contracts.characters.getCharacterId(tokenId)];
                case 8:
