...
function iterateBlocks(getLogs, name, address, fromBlock, toBlock, event, processLog, updateConfig) {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 7:
                    _a.sent();
                    _a.label = 8;
                case 8: return [4 /*yield*/, iterateBlocks(getLogs, name, address, toBlock2, toBlock, event, processLog, updateConfig)];
                case 9:
                    _a.sent();
                    return [3 /*break*/, 11];
                case 10:
