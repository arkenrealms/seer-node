...
export const seed = async function (knex): Promise<any> {
    console.log('[DB] Seeding profiles')
    ...
    const data = [
        {
            status: 'active',
            name: 'Profile name',
            accountId: (await Account.query(knex).limit(1))[0].id,
            address: null,
            avatar: null,
            role: 'developer', // [developer, user]
            value: 'i dont even get why i need to set this',
            ownedProducts: [], // await Product.query(knex).findById(1)
            meta: {
        ...
        },
        {
            ...
            value: 'i dont even get why i need to set this',
            meta: {
                wallet: '0xfe236119c6Dd3656436F9f087070a429e4BfD91d',
                img: 'https://i1.wp.com/www.winhelponline.com/blog/wp-content/uploads/2017/12/user.png?fit=256%2C256&quality=100&ssl=1',
                default: true,
                edit: false,
                messages: [],
